...
DEFAULT_TEMPLATES = {
    ...
    "offer_50": {
        ...
        "enabled": True,
        "body_html": "<h1 style=\"margin:14px 0 10px;font:800 26px/1.25 Arial,Helvetica,sans-serif;color:#ffffff;\">{{OFFER_PERCENT}}% off your first month.</h1>\n\n<p style=\"margin:0 0 16px;font:400 16px/1.62 Arial,Helvetica,sans-serif;color:#c9c9c9;\">Start your <strong style=\"color:#fff;\">3-day free trial</strong> in the next <strong style=\"color:#fff;\">{{OFFER_HOURS}} hours</strong> and the first month after it is half price. You're not charged during the trial at all, and cancelling inside it costs nothing.</p>\n\n<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:6px 0 20px;background:#1a1a1a;border:1px solid #dc262655;border-radius:12px;\"><tr><td align=\"center\" style=\"padding:20px;\"><p style=\"margin:0 0 6px;font:400 13px/1.4 Arial,Helvetica,sans-serif;color:#8a8a8a;text-transform:uppercase;letter-spacing:1px;\">Creator plan, first month</p><p style=\"margin:0;font:800 30px/1.2 Arial,Helvetica,sans-serif;color:#ffffff;\"><span style=\"color:#777777;text-decoration:line-through;font-weight:400;\">$30</span> &nbsp;$15</p><p style=\"margin:8px 0 0;font:400 13px/1.4 Arial,Helvetica,sans-serif;color:#8a8a8a;\">Pro: <span style=\"text-decoration:line-through;\">$50</span> $25 &nbsp;&middot;&nbsp; then the usual price, cancel any time</p></td></tr></table>\n\n<h2 style=\"margin:22px 0 8px;font:700 18px/1.3 Arial,Helvetica,sans-serif;color:#ffffff;\">What you get for it</h2>\n\n<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:0 0 11px;\"><tr><td valign=\"top\" style=\"width:22px;font:700 16px Arial,Helvetica,sans-serif;color:#dc2626;\">&#10003;</td><td style=\"font:400 15px/1.55 Arial,Helvetica,sans-serif;color:#c9c9c9;\"><strong style=\"color:#ffffff;\">An editor you talk to</strong> &mdash; cuts, silences, filler words, captions, music, b-roll. You describe it, the agent does it.</td></tr></table>\n\n<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:0 0 11px;\"><tr><td valign=\"top\" style=\"width:22px;font:700 16px Arial,Helvetica,sans-serif;color:#dc2626;\">&#10003;</td><td style=\"font:400 15px/1.55 Arial,Helvetica,sans-serif;color:#c9c9c9;\"><strong style=\"color:#ffffff;\">The AI model included</strong> &mdash; no API key, no second bill.</td></tr></table>\n\n<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:0 0 11px;\"><tr><td valign=\"top\" style=\"width:22px;font:700 16px Arial,Helvetica,sans-serif;color:#dc2626;\">&#10003;</td><td style=\"font:400 15px/1.55 Arial,Helvetica,sans-serif;color:#c9c9c9;\"><strong style=\"color:#ffffff;\">Clean exports</strong> &mdash; no watermark, and a priority place in the render queue.</td></tr></table>\n\n<table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin:14px 0 22px;\"><tr><td align=\"center\" bgcolor=\"#dc2626\" style=\"border-radius:10px;\"><a href=\"{{CTA_URL}}\" style=\"display:inline-block;padding:14px 32px;font:700 15px Arial,Helvetica,sans-serif;color:#ffffff;text-decoration:none;border-radius:10px;\">Claim {{OFFER_PERCENT}}% off &rarr;</a></td></tr></table>\n\n<p style=\"margin:0 0 16px;font:400 14px/1.6 Arial,Helvetica,sans-serif;color:#8a8a8a;\">The discount applies to your first month only, and it's one per account. After {{OFFER_HOURS}} hours it's gone and the plans go back to full price.</p>",
    },
}
