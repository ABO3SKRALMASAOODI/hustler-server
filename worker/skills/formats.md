...
- Montage / gameplay / sports: the music IS the structure. Cut on its beats, build to the peak, one slow-motion beat on the single best moment, HARD cuts — not a transition on every clip, and no sound effects unless asked. Never vertical-CROP gameplay (HUD lives at the edges) — fit it.
